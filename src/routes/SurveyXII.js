...
class SurveyXII extends React.Component {
  ...
  render() {
   ...
   <Header transparent style={{top:hp("-5%")}}>
        ...
        <View style={{top:hp("5%"), height:hp("2.5%"), width:wp("100%")}}>
          ...
          <Text style={{color: 'white', fontWeight:"bold", start:wp("25%")}}>XII.	HOUSEHOLD SAVINGS</Text>
        </LinearGradient>
        </View>
    </Header>
{/* <Text style={{fontWeight: "bold", fontSize:hp('2%')}}>1.	Date of Interview	: </Text> */}
<ScrollView>
<Label style={styles.customLabel}>1. Cash in Hand : </Label>
...
<Label style={styles.customLabel}>2. Friends and Relations : </Label>
<Label style={{start:wp("5%")}}>Amount per month (Rs.)</Label>
                    <Input
...
<Label style={{start:wp("5%")}}>Annual (Rs.)</Label>
                    <Input
						...
						autoCapitalize='none'
					/>
<Label style={styles.customLabel}>3. Jewels : </Label>
<Label style={{start:wp("5%")}}>Amount per month (Rs.)</Label>
                    <Input
...
<Label style={styles.customLabel}>4. Child Funds : </Label>
<Label style={{start:wp("5%")}}>Amount per month (Rs.)</Label>
                    <Input
...
<Label style={styles.customLabel}>5. Provident Fund : </Label>
<Label style={{start:wp("5%")}}>Amount per month (Rs.)</Label>
                    <Input
...
<Label style={styles.customLabel}>6. LIC : </Label>
<Label style={{start:wp("5%")}}>Amount per month (Rs.)</Label>
                    <Input
...
<Label style={styles.customLabel}>7. Post Office : </Label>
<Label style={{start:wp("5%")}}>Amount per month (Rs.)</Label>
                    <Input
...
<Label style={styles.customLabel}>8. Banks : </Label>
<Label style={{start:wp("5%")}}>Amount per month (Rs.)</Label>
                    <Input
...
<Label style={styles.customLabel}>9. National Saving Certificate : </Label>
<Label style={{start:wp("5%")}}>Amount per month (Rs.)</Label>
                    <Input
...
<Label style={styles.customLabel}>10. Others : </Label>
<Label style={{start:wp("5%")}}>Amount per month (Rs.)</Label>
                    <Input
