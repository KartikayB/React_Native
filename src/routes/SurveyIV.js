...
class SurveyIV extends React.Component {
  ...
  render() {
   ...
   <Header transparent style={{top:hp("-5%")}}>
        ...
        <View style={{top:hp("5%"), height:hp("2.5%"), width:wp("100%")}}>
          ...
          <Text style={{color: 'white', fontWeight:"bold", start:wp("25%")}}>IV. AREA OF OCCUPATION </Text>
        </LinearGradient>
        </View>
    </Header>
...
<View style={{flexDirection: 'row'}}>
        <Text style={{fontSize:hp('2.5%'),fontWeight: "bold", start:hp("-8%"),top:wp("4%")}}>  Urban  </Text>
<Radio color={"#99cc00"}
...
<View style={{flexDirection: 'row'}}>
        <Text style={{fontSize:hp('2.5%'),fontWeight: "bold", start:hp("-8%"),top:wp("4%")}}>  Rural  </Text>
<Radio color={"#99cc00"}
                selectedColor={"#99cc00"}
                selected={this.state.radio2}
                style={{start:hp("5.4%"),top:wp("4%")}}
