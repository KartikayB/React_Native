...
export default class ReduceScreen extends Component {
  ...
  onSwipe(gestureName, gestureState) {
    ...
    switch (gestureName) {
      case SWIPE_LEFT:
		...
		this.setState({backgroundColor: '#fff'},Actions.remove());
		
        break;
      case SWIPE_RIGHT:
        this.setState({backgroundColor: '#fff'},Actions.measure());
        break;
    }
  }
