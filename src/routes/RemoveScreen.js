  ...
  onSwipe(gestureName, gestureState) {
    ...
    switch (gestureName) {
      case SWIPE_LEFT:
		...
		this.setState({backgroundColor: '#fff'},Actions.login());
    ...
    return(
      ...
      >
        ...
        <Container>
          ...
          <Text style={{fontSize:50, alignSelf: "center",paddingTop:30}}>Remove</Text>

          <Image
            style={{width: "100%", height: 300,  alignItems:"center", justifyContent: "center"}}
            source={require('../../util/images/remove_screen_img.png')}
          />

            <Text style={{fontSize:20, alignSelf: "center",fontWeight: "bold",paddingLeft:40,paddingRight:20, paddingBottom:75}}>
          Select projects to remove the equivalent amount of C-Emissions that you have produced </Text>
