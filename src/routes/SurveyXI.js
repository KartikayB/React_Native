...
class SurveyXI extends React.Component {
  ...
  render() {
   ...
   <Header transparent style={{top:hp("-5%")}}>
        ...
        <View style={{top:hp("5%"), height:hp("2.5%"), width:wp("100%")}}>
          ...
          <Text style={{color: 'white', fontWeight:"bold", start:wp("20%")}}>XI. HOUSEHOLD EXPENDITURE</Text>
        </LinearGradient>
        </View>
    </Header>
{/* <Text style={{fontWeight: "bold", fontSize:hp('2%')}}>1.	Date of Interview	: </Text> */}
<ScrollView>
<Label style={styles.customLabel}>1. Food : </Label>
...
<Label style={styles.customLabel}>2. Clothing : </Label>
<Label style={{start:wp("5%")}}>Amount per month (Rs.)</Label>
                    <Input
...
<Label style={{start:wp("5%")}}>Annual (Rs.)</Label>
                    <Input
						...
						autoCapitalize='none'
					/>
<Label style={styles.customLabel}>3. Rent : </Label>
<Label style={{start:wp("5%")}}>Amount per month (Rs.)</Label>
                    <Input
...
<Label style={styles.customLabel}>4. Fuel and Electricity : </Label>
<Label style={{start:wp("5%")}}>Amount per month (Rs.)</Label>
                    <Input
...
<Label style={styles.customLabel}>5. Education : </Label>
<Label style={{start:wp("5%")}}>Amount per month (Rs.)</Label>
                    <Input
...
<Label style={styles.customLabel}>6. Medical Expenses : </Label>
<Label style={{start:wp("5%")}}>Amount per month (Rs.)</Label>
                    <Input
...
<Label style={styles.customLabel}>7. Social and Religious Ceremonies : </Label>
<Label style={{start:wp("5%")}}>Amount per month (Rs.)</Label>
                    <Input
...
<Label style={styles.customLabel}>8. Entertainment : </Label>
<Label style={{start:wp("5%")}}>Amount per month (Rs.)</Label>
                    <Input
...
<Label style={styles.customLabel}>9. Smoking and Drinking : </Label>
<Label style={{start:wp("5%")}}>Amount per month (Rs.)</Label>
                    <Input
						value={this.state.Q9amt}
						onChangeText={(Q9amt)=>this.setState({Q9amt})}
						style={styles.inputBox2}
						autoCapitalize='none'
					/>
<Label style={{start:wp("5%")}}>Annual (Rs.)</Label>
                    <Input
						value={this.state.Q9annual}
						onChangeText={(Q9annual)=>this.setState({Q9annual})}
						style={styles.inputBox2}
						autoCapitalize='none'
					/>     

<Label style={styles.customLabel}>10. Repayment of Loans : </Label>
<Label style={{start:wp("5%")}}>Amount per month (Rs.)</Label>
                    <Input
						value={this.state.Q10amt}
						onChangeText={(Q10amt)=>this.setState({Q10amt})}
						style={styles.inputBox2}
						autoCapitalize='none'
					/>
<Label style={{start:wp("5%")}}>Annual (Rs.)</Label>
                    <Input
						value={this.state.Q10annual}
						onChangeText={(Q10annual)=>this.setState({Q10annual})}
						style={styles.inputBox2}
						autoCapitalize='none'
					/>     

<Label style={styles.customLabel}>11. Miscellaneous : </Label>
<Label style={{start:wp("5%")}}>Amount per month (Rs.)</Label>
                    <Input
						value={this.state.Q11amt}
						onChangeText={(Q11amt)=>this.setState({Q11amt})}
						style={styles.inputBox2}
						autoCapitalize='none'
					/>
<Label style={{start:wp("5%")}}>Annual (Rs.)</Label>
                    <Input
						value={this.state.Q11annual}
						onChangeText={(Q11annual)=>this.setState({Q11annual})}
						style={styles.inputBox2}
						autoCapitalize='none'
					/>                    
