...
class SurveyXIV extends React.Component {
  ...
  render() {
   ...
   <Header transparent style={{top:hp("-5%")}}>
        ...
        <View style={{top:hp("5%"), height:hp("2.5%"), width:wp("100%")}}>
          ...
          <Text style={{color: 'white', fontWeight:"bold",start:wp("30%")}}>XIV. FIXED ASSETS</Text>
        </LinearGradient>
        </View>
    </Header>
...
<Text style={{fontSize:hp('2.5%'),fontWeight: "bold", start:hp("-10%"),top:wp("4%")}}>a. Debt owe to Bank  </Text>
<Radio color={"#99cc00"}
...
<View style={{flexDirection: 'row', paddingBottom:hp("1.5%")}}>
        <Text style={{fontSize:hp('2.5%'),fontWeight: "bold", start:hp("-7%"),top:wp("4%")}}>b. Debt owe to contractor  </Text>
<Radio color={"#99cc00"}
                selectedColor={"#99cc00"}
                selected={this.state.radio2}
                style={{start:hp("2%"),top:wp("4%")}}
                onPress= {() => {this.radio2_fn()} }>
            
            </Radio>
       </View>
<View style={{flexDirection: 'row', paddingBottom:hp("1.5%")}}>
        <Text style={{fontSize:hp('2.5%'),fontWeight: "bold", start:hp("-4.5%"),top:wp("4%")}}>c. Dept owe to money lenders  </Text>
<Radio color={"#99cc00"}
                selectedColor={"#99cc00"}
                selected={this.state.radio3}
                style={{start:hp("-0.3%"),top:wp("4%")}}
